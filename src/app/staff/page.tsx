...
export default async function StaffPage() {
  ...
  const { data: event } = await supabase
    .from("events")
    .select(
      "id, name, status, start_at, end_at, time_limit_minutes, default_destination_bonus_amount, leaderboard_hide_minutes_before_end, obstruction_cooldown_seconds, active_destination_station_id, active_destination:active_destination_station_id(name)"
    )
    .eq("id", actor.eventId)
    .single();
